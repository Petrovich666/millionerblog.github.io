...
<header class="">
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="index.php"><h2>Банкир<em>.</em></h2></a>
...
<div class="heading-page header-text">
    <section class="page-heading" style="background-image: url('./assets/images/daniel-h-tong-uesvuw_hf7u-unsplash.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
